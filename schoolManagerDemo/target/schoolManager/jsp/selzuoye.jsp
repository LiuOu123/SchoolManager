    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                    ...
                    <table class="layui-table layui-form">
                        ...
                        <c:forEach items="${list.list}" var="l">
                            <tr>
                                <td>${l.reltitle}</td>
                                <td>${l.relnei}</td>
                                <td><fm:formatDate value="${l.reldate}"></fm:formatDate></td>
                                <td>
                                    <button onclick="selhuifu(${l.rid})">查看回复</button>
                                </td>
                                <td>
                ...
                <center>
                    <div>
                        <a href="/selzuoye?pn=${list.firstPage}">首页</a>
                        <c:if test="${list.hasPreviousPage}">
                            <a href="/selzuoye?pn=${list.prePage}">上一页</a>
                        </c:if>
                        <c:forEach items="${list.navigatepageNums}" var="i">
                            <a href="/selzuoye?pn=${i}">${i}</a>
                        </c:forEach>
                        <c:if test="${list.hasNextPage}">
                            <a href="/selzuoye?pn=${list.nextPage}">下一页</a>
                        </c:if>
                        <a href="/selzuoye?pn=${list.lastPage}">尾页</a>
                    </div>
                </center>
            </div>
        </div>
...
<script>
    function tijiao() {
        location.href = "/jsp/tijiaozuoye.jsp"
    }

    function selhuifu(rid) {
        location.href = "/selhuifu?rid=" + rid;
    }
